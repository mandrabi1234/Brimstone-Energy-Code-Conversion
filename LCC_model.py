...
#------------------------------------------------------------------------------------------------------------------------------------------
  ...
  cleanE, inputs(1), inputs(2), inputs(3), inputs(4), inputs(5), ...
  inputs(6), inputs(7), inputs(8), inputs(9), inputs(10), ...
  inputs(11), inputs(12), inputs(13), inputs(14), inputs(15), ...
  inputs(16), inputs(17), inputs(18), inputs(19), ...
  inputs(20), inputs(21), inputs(22), inputs(23), inputs(24), ...
  ...
  names = {'Electrolyzer Cost (USD/kW) 50->1000', 'CO_2 Tax (USD/T CO_2) -190->100'...
          ...
          'CO_2 Intensity of Electricity (T CO_2/kWhr) 0->0.001', ...
          'Price per T of SCM (USD/T) 0->100', 'Sulfur Cost (USD/T) 0->200', ...
          'Plant Size (T OPC/yr) 1M->5M', ...
          'Co-product Revenue per T OPC 0->500'...
